<h1 align="center">TerminalShell</h1>
...
<img width="1858" height="936" alt="TerminalShell terminal workspace" src="https://github.com/user-attachments/assets/e32b021a-91b2-4930-8e09-182278c365c6" />

<img width="1858" height="936" alt="TerminalShell multi-terminal workspace" src="https://github.com/user-attachments/assets/7675d0cc-5489-491b-8aeb-78571457a835" />
...
Download Windows x64 packages from GitHub Releases:

- `TerminalShell-win-x64-dotnet8-dependent.zip`: smaller package, requires `.NET 8 Desktop Runtime` on the target machine.
- `TerminalShell-win-x64-allinone.zip`: larger package, includes the .NET runtime and can run after extraction.
...
<img width="1858" height="936" alt="TerminalShell remote web console" src="https://github.com/user-attachments/assets/92a48235-1134-4e98-821c-53e527ad601c" />
...
<img width="1825" height="1341" alt="TerminalShell settings window" src="https://github.com/user-attachments/assets/f41161ca-22c8-41e3-8e98-7aeccad20874" />

Terminal configuration fields include terminal name, terminal voice name, history folder, shell type, working directory, startup command, main-window visibility, and automatic draft queue behavior.
...
docs\                       user documentation and GitHub homepage README
```
